...
public class EmployeeServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee emp = service.newPersist(
                    parseInt(request.getParameter("id")),
                    request.getParameter("name"),
                    parseLong(request.getParameter("salary")));
            out.println("Persisted " + emp);
        } else if (action.equals("Merge")) {
            Employee emp = service.newMerge(
                    parseInt(request.getParameter("id")),
                    request.getParameter("name"),
                    parseLong(request.getParameter("salary")));
            out.println("Merged " + emp);
        }else if (action.equals("Refresh")) {
            Employee emp = service.newRefresh(
                    parseInt(request.getParameter("id")),
                    request.getParameter("name"),
                    parseLong(request.getParameter("salary")));
            out.println("Refresh " + emp);
        } else if (action.equals("Remove")) {
            Employee emp = service.newRemove(
                    parseInt(request.getParameter("id")),
                    request.getParameter("name"),
                    parseLong(request.getParameter("salary")));
            out.println("Remove " + emp);
        } 
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<td><input name=\"action\" type=\"submit\" value=\"Persist\"/></td></tr>");
        out.println("<td><input name=\"action\" type=\"submit\" value=\"Merge\"/></td></tr>");
        out.println("<td><input name=\"action\" type=\"submit\" value=\"Refresh\"/></td></tr>");
