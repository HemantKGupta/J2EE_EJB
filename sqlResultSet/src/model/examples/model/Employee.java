...
public class Employee {
    ...
    // getAddress() will return ADDR_ID foreign key from table
    public String toString() {
        return "Employee id: " + getId() + 
        	   " name: " + getName() + 
        	   " salary: " + getSalary() + 
               " with Manager Id: " + (getManager() == null ? null : getManager().getId())+
               " with Address Id: " +(getAddress() == null ? null : getAddress().getId())+
               " with Department Id: " +(getDepartment() == null ? null : getDepartment().getId());
    }
}
